function s(e){e.innerHTML=`
      ...
      <aside class="contact-split__info">
        <div class="contact-split__info-inner reveal">
          ...
          <div class="contact-split__detail">
            ...
            <div><h3>Phone</h3><p>+44 7749 896334</p><small>Mon–Fri 9am–6pm</small></div>
          </div>
          <div class="contact-split__detail">
  ...
  `;const a=e.querySelector("#contact-form"),t=e.querySelector("#form-status");a&&t&&a.addEventListener("submit",i=>{i.preventDefault(),t.style.display="block",t.textContent="✓ Thank you! We will be in touch within 24 hours.",a.reset()})}export{s as renderPage};
